...
const MenuBox = ({ icon, title, description, onLanding }: MenuBoxProps) => {
    return (
           <div className='w-full h-[14.4rem] rounded-[16px] bg-gradient-to-br from-[#1447E6] to-[rgba(127,156,219,0.82)] shadow-md p-[2rem]' onClick={onLanding}>
